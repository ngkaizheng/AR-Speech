...
namespace IBM.Cloud.SDK.Authentication.Iam
{
    ...
    public class IamAuthenticator : Authenticator
    {
        ...
        bool RequestToken(Callback<IamTokenResponse> callback)
        {
            ...
            {
                req.Headers.Add("Authorization", IBM.Cloud.SDK.Utilities.Utility.CreateAuthorization(ClientId, ClientSecret));
            }
        ...
        public override void Validate()
        {
            ...
            if (IBM.Cloud.SDK.Utilities.Utility.HasBadFirstOrLastCharacter(Apikey))
            {
